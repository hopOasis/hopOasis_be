...
public class ProductBundleController {
  ...
  @PostMapping
  public ResponseEntity<ProductBundleInfoDto> saveProductBundle(
  ...
  public ResponseEntity<?> addRating(@PathVariable("id") Long id,
    ...
    try {
      ...
      ProductBundleInfoDto dto = productBundleService.addRatingAndReturnUpdatedProductBundleInfo(id,
          ratingValue);
      return ResponseEntity.ok().body(dto);
