...
import com.example.hop_oasis.repository.SpecialOfferRepository;
...
public class SpecialOfferServiceImpl {
  ...
  public SpecialOfferAllProductDto getSpecialOffer(Long offerId) {
    ...
    return SpecialOfferAllProductDto.builder()
        ...
        .specialOfferProductBundles(
            productBundleInfoMapper.toDtos(specialOfferProduct.getProductBundles()))
        .build();
  }
  ...
  public void addProductBundleToSpecialOffer(Long productBundleId, Long offerId) {
    ...
    try {
      ...
      throw new ResourceNotFoundException("Product bundle already added to special offer",
          productBundleId);
    }
  }
